...
@section('main')
    ...
    <script type="text/javascript" charset="utf-8">
        var dateHtml = '<div class="dateDiv pr"><div class="marTBd8r in_block font13 pr selectDate" style="width: 34%;"><select class="selectDown" name="date1"><option value="1">星期一</option><option value="2">星期二</option><option value="3">星期三</option><option value="4">星期四</option><option value="5">星期五</option></select><span class="downBtn"></span></div>&nbsp;<div class="marTBd8r in_block font13 pr selectDate" style="width: 44%;"><select class="selectDown" name="hour1"><option value="6点后">6点后</option><option value="7点后">7点后</option><option value="8点后">8点后</option><option value="整晚都可以">整晚都可以</option></select><span class="downBtn"></span></div><span class="deleteBtn" onclick="deleteDate(this)">-</span></div>'
