...
<section class="pr">
        ...
        <ul class="date-line-wrap">
            ...
            <li class="clearfix">
                <p class="data-line-box clearfix fr"><span class="fl date-line-left">分配的维修成功的机子有</span><span class="fl date-line-right"><i>{{$assign_list_count}}</i><i style="width:2.7rem">台</i></span></p>
                <i class="circle"></i>
            </li>
            <li class="clearfix">
